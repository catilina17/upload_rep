...
def run_calculator_pn_ech(dar, horizon, source_data, name_product, tx_params=[],
                         ...
                         cr_immo_cal_mode = "quick", type_run_off="absolute"):
    try:

        cls_ech = load_pn_data(source_data["PN"], dar, tx_params, map_bassins, max_pn, type_ech, batch_size, type_run_off)
...
def load_pn_data(source_data, dar_usr, tx_params, map_bassins, max_pn, type_ech, batch_size, type_run_off):
