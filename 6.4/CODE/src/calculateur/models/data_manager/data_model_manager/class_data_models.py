...
class Data_Model_Params():
    def __init__(self, cls_hz_params, cls_fields, name_product, modele_wb, modele_pel=None):
        self.name_product = name_product
        self.fichier_modele = modele_wb
        self.fichier_modele_pel = modele_pel
    ...
    def create_all_model_types(self):
        ...
        elif self.name_product in ["nmd_st", "nmd_pn"]:
            self.cls_ra_rn_params = Data_RA_PEL_Model_Params(self.fichier_modele_pel,
                                                             self.cls_hz_params.nb_months_proj)
            self.cls_ra_rn_params.load_pel_model_params()

            self.cls_versement_params = Data_Versements_PEL(self.fichier_modele_pel, self.cls_fields,
