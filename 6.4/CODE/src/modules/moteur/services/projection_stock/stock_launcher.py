...
import modules.moteur.services.projection_stock.stock_projection as sp
import modules.moteur.services.projection_stock.stock_compiler as sc

import logging
logger = logging.getLogger(__name__)

def project_loop_stock(dic_stock_ref, dic_stock_ind_ref, dic_updated, name_scenario, new_dir):
    dic_stock_ind = {};
    dic_stock_ratio = {}
