import numpy as np
from ...rate_services.shocks_controller import non_paralllel_chocs_controller as non_parallel_cs
from ...rate_services.shocks_controller import parallel_chocs_controller as parallel_cs
