class PASS_ALM_Fields():
    ...
    MAX_MONTHS_ST = 300
    MAX_MONTHS_PN = 60
    ALL_NUM_STOCK = [x for x in range(0, 121)] + [x for x in range(132, MAX_MONTHS_ST  + 1, 12)]
    
    NC_PA_COL_SORTIE_NUM_ST = ["M" + str(i) for i in range(0, 120 + 1)] + ["M" + str(i) for i in
                                                                     range(132, MAX_MONTHS_ST + 1, 12)]

    NC_PA_COL_SORTIE_NUM_ST2 =  ["M" + str(i) for i in range(0, MAX_MONTHS_ST + 1)]
