...
from mappings.mappings_moteur import Mappings as map_cls
import numpy as np
import pandas as pd
import modules.moteur.parameters.user_parameters as up
import utils.excel_utils as ex
import mappings.mappings_moteur as mp
...
def load_nsfr_params(wb):
    global coeffs_nsfr, bc_outflow_nsfr
    """ COEFFS NSFR"""
    coeffs_nsfr = map_cls.load_map(wb, name_range=gp.ng_param_nsfr,
