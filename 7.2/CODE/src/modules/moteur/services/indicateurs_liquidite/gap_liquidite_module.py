...
class Gap_Liquidite_Calculator():
    def __init__(self, cls_usr, cls_mp):
        self.up = cls_usr
        self.mp = cls_mp

    def calcul_gap_liq_pn(self, dic_pn_sci, data_dic, simul, cols):
    ...
    def calcul_gap_liq_st(self, dic_stock_sci, simul):
    ...
    def calcul_gap_liq_ajust(self, dic_ajust, simul, num_cols):
    ...
    def appliquer_conv_ecoulement_gp_liq(self, dic_ind, typo, data, data_other, simul):
        if (self.up.force_gp_liq and simul=="LIQ") or (self.mp.mapping_eve["force_gp_liq_eve"] and "EVE" in simul):
            self.force_gap_liq(dic_ind, typo, data_other, simul, option_data=data)
        if (self.up.force_gps_nmd and simul=="LIQ") or (self.mp.mapping_eve["force_gps_nmd_eve"] and "EVE" in simul):
            self.force_gap_liq_nmd(dic_ind, typo, data, simul)


    def force_gap_liq(self, dic_ind, typo, data, simul, option_data=""):
        ...
        if typo == "PN":
            ...
            data2 = data2.join(self.mp.contrats_map[add_cols].copy(), on=gp.nc_output_contrat_cle,
                               how="left")
        ...
        profil_ecoul_gpp = data2.join(self.mp.conv_gpliq, on="key_gpliq")[
    ...
    def force_gap_liq_nmd(self, dic_ind, typo, data, simul):
