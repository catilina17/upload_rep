...
def generate_PN_REFI_MLT(DAR, etab, file_path):
    if os.path.exists(file_path):
        ...
        for c in list_contrats:
            ...
            dic_refi_mlt[c] = mp.map_data(dic_refi_mlt[c], mapping_refi_bpce, keys_data=[pa.NC_PA_CONTRACT_TYPE],
                                            join_how="inner")
            dic_refi_mlt[c] = mp.map_data(dic_refi_mlt[c], mapping_conso_ech, keys_data=[pa.NC_PA_CONTRACT_TYPE],
                                            join_how="inner")
