...
def get_stock_sc_tx_df(etab, st_refs):
    scenario_name_df = st_refs[st_refs['ENTITE'] == etab]
    if scenario_name_df.empty:
        scenario_name_df = st_refs[st_refs['ENTITE'] == 'DEFAULT']
