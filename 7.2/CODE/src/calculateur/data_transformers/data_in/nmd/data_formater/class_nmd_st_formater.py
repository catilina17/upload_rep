...
class Data_NMD_ST_Formater():
    ...
    def apply_filters(self, data_nmd_st):
        ...
        #data_nmd_st = data_nmd_st[data_nmd_st[self.cls_fields.NC_LDP_CONTRACT_TYPE] == "P-LIV-JEUNE"].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st[self.cls_fields.NC_LDP_MARCHE].isin(["PRO"])].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st[self.cls_fields.NC_LDP_CURRENCY].isin(["EUR"])].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st[self.cls_fields.NC_LDP_MARCHE].isin(["AUTRES"])].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st[self.cls_fields.NC_LDP_ETAB].isin(["BPRVP"])].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st[self.cls_fields.NC_LDP_MARCHE].isin(["PARTICULIERS"])].copy()
        #data_nmd_st = data_nmd_st[~data_nmd_st[self.cls_fields.NC_LDP_CONTRACT_TYPE].str.contains("P-ICNE")].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st["CONTRACT_TYPE".upper()].isin(["P-DAV-PART"])].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st["ETAB"].isin(["BCP_PARIS"])].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st["FAMILY"].isin(["PPROTEGEES"])].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st["CONTRACT_TYPE"].isin(["A-LIGNE-INT"])].copy()
    ...
    def filter_data(self, data_nmd_st):
        ...
        #data_nmd_st = data_nmd_st[data_nmd_st[self.cls_fields.NC_LDP_CONTRACT_TYPE].str.contains("P-PEL-2013")].copy()
        #data_nmd_st = data_nmd_st[data_nmd_st[self.cls_fields.NC_LDP_ETAB].isin(["CEBPL"])].copy()
