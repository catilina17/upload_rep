...
class Rate_Manager():
    ...
    def get_rates(self, cls_proj, cls_model_params):
        ...
        if (cls_proj.name_product != "cap_floor"):
            if _n > 0:
                (sc_rates[is_tv], sc_rates_lag[is_tv], tombee_fixing[is_tv], sc_rates_ftp[is_tv],
    ...
    def get_scenario_rates(self, data_ldp, data_rate_sc, fixing_calendar, current_month,
        ...
        return sc_rates, sc_rates_lag, tombee_fixing, sc_rates_ftp, sc_rates_ftp_lag, period_fixing
