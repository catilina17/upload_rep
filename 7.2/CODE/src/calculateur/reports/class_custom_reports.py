...
class Custom_Reports():
    ...
    def __init__(self, cls_fields, list_cls_agreg, output_folder, sim_params, dar, produit, is_liquidity_report,
        ...
        self.list_tf = ["a-creq", "a-crctz", "a-crctf", "a-intbq-tf", "p-intbq-tf", "p-cat-tf",
                        ...
                        "p-security-tf", "p-repo-tf", "a-repo-tf"]
    ...
    def add_data_qual_report(self, data_report, data_type):
        ...
        # PRODUIT
        if not self.name_product in models_ech_pn:
        ...
        if False:  # True:
            ...
            data_report = data_report[
                ["VERSION", pa.NC_PA_CONTRACT_TYPE, pa.NC_PA_MARCHE, pa.NC_PA_ETAB, pa.NC_PA_DEVISE,
                 ...
                 "DRAC", "TYPE", pa.NC_PA_IND03] + self.cols_num].copy()
        else:
            data_report = data_report[
    ...
    def add_rco_data(self, fichier_rco, name_prod, is_ag_report, is_model_report):
        if fichier_rco != "":
            ...
            if self.name_product in models_ech_pn:
            ...
            elif self.name_product in models_nmd_pn:
                data_rco = data_rco[data_rco[pa.NC_PA_IND03].isin(
    ...
    def filter_by_contract(self, name_prod, data_rco):
        ...
        elif (name_prod in (models_nmd_st + models_nmd_pn)):
        ...
        elif (name_prod in ["a-repo-tf", "a-repo-tv"]):
            data_rco = data_rco[
                data_rco[pa.NC_PA_CONTRACT_TYPE].isin(['A-PRISE-PENS'])].copy()

        elif (name_prod in ["p-repo-tf", "p-repo-tv"]):
            data_rco = data_rco[data_rco[pa.NC_PA_CONTRACT_TYPE].isin(['P-MISE-PENS', 'P-MISE-OR', "P-MISE-PENS-OR",
                                                                       'P-MISE-PA'])].copy()
